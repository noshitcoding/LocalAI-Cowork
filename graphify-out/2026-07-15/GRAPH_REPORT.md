# Graph Report - Open_Cowork  (2026-07-15)

## Corpus Check
- 306 files · ~312,615 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4786 nodes · 12056 edges · 192 communities (174 shown, 18 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 96 edges (avg confidence: 0.73)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `29575217`
...
- [[_COMMUNITY_crewStore.ts|crewStore.ts]]
- [[_COMMUNITY_registry.ts|registry.ts]]
- [[_COMMUNITY_String|String]]
- [[_COMMUNITY_crew_python_bridge.rs|crew_python_bridge.rs]]
- [[_COMMUNITY_CoworkView.tsx|CoworkView.tsx]]
- [[_COMMUNITY_AppHandle|AppHandle]]
- [[_COMMUNITY_App.tsx|App.tsx]]
- [[_COMMUNITY_ollamaClient.ts|ollamaClient.ts]]
- [[_COMMUNITY_Option|Option]]
- [[_COMMUNITY_tr|tr]]
- [[_COMMUNITY_index.ts|index.ts]]
- [[_COMMUNITY_Database|Database]]
- [[_COMMUNITY_index.ts|index.ts]]
- [[_COMMUNITY_ServiceError|ServiceError]]
- [[_COMMUNITY_ollama.rs|ollama.rs]]
- [[_COMMUNITY_workTaskCrewRuntime.ts|workTaskCrewRuntime.ts]]
- [[_COMMUNITY_properties|properties]]
- [[_COMMUNITY_artifact_pipeline.rs|artifact_pipeline.rs]]
- [[_COMMUNITY_useConfigStore|useConfigStore]]
- [[_COMMUNITY_safeInvoke|safeInvoke]]
- [[_COMMUNITY_main.py|main.py]]
- [[_COMMUNITY_Capability|Capability]]
- [[_COMMUNITY_String|String]]
- [[_COMMUNITY_coworkStore.ts|coworkStore.ts]]
- [[_COMMUNITY_configStore.ts|configStore.ts]]
- [[_COMMUNITY_context.rs|context.rs]]
- [[_COMMUNITY_cowork_features.rs|cowork_features.rs]]
- [[_COMMUNITY_properties|properties]]
- [[_COMMUNITY_chatStore.ts|chatStore.ts]]
- [[_COMMUNITY_mcp.rs|mcp.rs]]
- [[_COMMUNITY_properties|properties]]
- [[_COMMUNITY_openaiCompatibleClient.ts|openaiCompatibleClient.ts]]
- [[_COMMUNITY_engineStore.ts|engineStore.ts]]
- [[_COMMUNITY_Option|Option]]
- [[_COMMUNITY_personalityStore.ts|personalityStore.ts]]
- [[_COMMUNITY_terminal_sessions.rs|terminal_sessions.rs]]
- [[_COMMUNITY_chatAttachments.ts|chatAttachments.ts]]
- [[_COMMUNITY_CrewLiveMonitor.tsx|CrewLiveMonitor.tsx]]
- [[_COMMUNITY_EventEnvelope|EventEnvelope]]
- [[_COMMUNITY_office_integration.rs|office_integration.rs]]
- [[_COMMUNITY_LeftSidebar.tsx|LeftSidebar.tsx]]
- [[_COMMUNITY_toolOrchestrator.ts|toolOrchestrator.ts]]
- [[_COMMUNITY_Vec|Vec]]
- [[_COMMUNITY_claude_code_bridge.rs|claude_code_bridge.rs]]
- [[_COMMUNITY_properties|properties]]
- [[_COMMUNITY_properties|properties]]
- [[_COMMUNITY_AuditEvent|AuditEvent]]
- [[_COMMUNITY_file_safety.rs|file_safety.rs]]
- [[_COMMUNITY_properties|properties]]
- [[_COMMUNITY_Message|Message]]
- [[_COMMUNITY_audit_service.rs|audit_service.rs]]
- [[_COMMUNITY_projectStore.ts|projectStore.ts]]
- [[_COMMUNITY_db.rs|db.rs]]
- [[_COMMUNITY_validate-product-docs.mjs|validate-product-docs.mjs]]
- [[_COMMUNITY_insightsStore.ts|insightsStore.ts]]
- [[_COMMUNITY_crew_provider_health_check|crew_provider_health_check]]
- [[_COMMUNITY_tauri.conf.json|tauri.conf.json]]
- [[_COMMUNITY_terminalStore.ts|terminalStore.ts]]
- [[_COMMUNITY_properties|properties]]
- [[_COMMUNITY_registry.ts|registry.ts]]
- [[_COMMUNITY_RunPanel.tsx|RunPanel.tsx]]
- [[_COMMUNITY_QueryEngine|QueryEngine]]
- [[_COMMUNITY_.open_in_memory|.open_in_memory]]
- [[_COMMUNITY_validate-agent-discipline.mjs|validate-agent-discipline.mjs]]
- [[_COMMUNITY_devDependencies|devDependencies]]
- [[_COMMUNITY_i18n-audit.mjs|i18n-audit.mjs]]
- [[_COMMUNITY_messageDisplay.ts|messageDisplay.ts]]
- [[_COMMUNITY_globalSearch.ts|globalSearch.ts]]
- [[_COMMUNITY_RequestContext|RequestContext]]
- [[_COMMUNITY_compilerOptions|compilerOptions]]
- [[_COMMUNITY_Feature 2 Zusammenklapp-Buttons für Task-Chats|Feature 2: Zusammenklapp-Buttons für Task-Chats]]
- [[_COMMUNITY_lifecycle.ts|lifecycle.ts]]
- [[_COMMUNITY_ollamaStreaming.ts|ollamaStreaming.ts]]
- [[_COMMUNITY_UI-Anforderungsliste fuer Open_Cowork|UI-Anforderungsliste fuer Open_Cowork]]
- [[_COMMUNITY_memoryStore.ts|memoryStore.ts]]
- [[_COMMUNITY_workTasksStore.ts|workTasksStore.ts]]
- [[_COMMUNITY_terminal_backends.rs|terminal_backends.rs]]
- [[_COMMUNITY_INDEX|INDEX.md]]
- [[_COMMUNITY_5. Anforderungen pro Ansicht|5. Anforderungen pro Ansicht]]
- [[_COMMUNITY_check-budgets.mjs|check-budgets.mjs]]
- [[_COMMUNITY_logStore.ts|logStore.ts]]
- [[_COMMUNITY_memory_engine.rs|memory_engine.rs]]
...
- [[_COMMUNITY_skill_engine.rs|skill_engine.rs]]
- [[_COMMUNITY_process_manager.rs|process_manager.rs]]
- [[_COMMUNITY_Fix for Per-ChatPer-Task Permission Mode and Allowed Directories|Fix for Per-Chat/Per-Task Permission Mode and Allowed Directories]]
- [[_COMMUNITY_5.3 Plan-, Approval- und Task-UI|5.3 Plan-, Approval- und Task-UI]]
- [[_COMMUNITY_Feature Implementierungsvergleich|Feature Implementierungsvergleich]]
- [[_COMMUNITY_Open Cowork|Open Cowork]]
- [[_COMMUNITY_insights.rs|insights.rs]]
- [[_COMMUNITY_Current Architecture|Current Architecture]]
- [[_COMMUNITY_FEHLENDE_FEATURES_IM_CODE|FEHLENDE_FEATURES_IM_CODE.md]]
- [[_COMMUNITY_duckduckgo-websearch-server.mjs|duckduckgo-websearch-server.mjs]]
- [[_COMMUNITY_documentWorkspaceStore.ts|documentWorkspaceStore.ts]]
...
- [[_COMMUNITY_Development und Betrieb|Development und Betrieb]]
...
- [[_COMMUNITY_Decisions|Decisions]]
- [[_COMMUNITY_Ollama Konfiguration|Ollama Konfiguration]]
...
- [[_COMMUNITY_Memory And Skill Discipline|Memory And Skill Discipline]]
- [[_COMMUNITY_Skills Index|Skills Index]]
- [[_COMMUNITY_openaiCompatibleClient.test.ts|openaiCompatibleClient.test.ts]]
...
- [[_COMMUNITY_refactor-settings.js|refactor-settings.js]]
- [[_COMMUNITY_refactor-ui.js|refactor-ui.js]]
- [[_COMMUNITY_.get_engine_run|.get_engine_run]]
...
2. `tr()` - 105 edges
3. `CoworkView()` - 77 edges
4. `safeInvoke()` - 55 edges
5. `useConfigStore` - 41 edges
6. `QueryEngine` - 36 edges
7. `ServiceError` - 33 edges
8. `hasTauriRuntime()` - 33 edges
9. `RequestContext` - 29 edges
10. `scripts` - 27 edges

## Surprising Connections (you probably didn't know these)
- `CoworkView()` --calls--> `parseArgs()`  [INFERRED]
  app/src/components/CoworkView.tsx → scripts/validate-product-docs.mjs
- `TasksView()` --calls--> `resolveCrewRuntimeConfig()`  [INFERRED]
  app/src/components/TasksView.tsx → app/src/components/CrewPanel.tsx
- `TasksView()` --calls--> `resolveExternalProviderConfig()`  [INFERRED]
  app/src/components/TasksView.tsx → app/src/components/CrewPanel.tsx
- `PersonalityEditor()` --calls--> `tr()`  [EXTRACTED]
  app/src/components/PersonalitySelector.tsx → app/src/i18n.ts
- `SupportBundlePanel()` --calls--> `tr()`  [EXTRACTED]
  app/src/components/SettingsView.tsx → app/src/i18n.ts
...
### Community 0 - "Result"
Cohesion: 0.05
Nodes (144): Database, ArtifactVersionRow, audit_event(), canonical_policy_tool_id(), chat_turn_stream(), claude_code_send_stream(), claude_code_stop(), crew_approval_create() (+136 more)
...
Cohesion: 0.05
Nodes (46): CrewControlPlanePanel(), formatTimestamp(), Props, CrewGovernancePanel(), formatApprovalStatus(), formatApprovalType(), formatTimestamp(), GOVERNANCE_MODES (+38 more)

### Community 3 - "registry.ts"
Cohesion: 0.03
Nodes (63): agentTool, askUserTool, AskUserToolInput, bashTool, copyPathTool, createDirectoryTool, deleteFileTool, DesktopActionResponse (+55 more)

### Community 4 - "String"
Cohesion: 0.05
Nodes (72): backend_delete(), backend_ensure_local(), backend_exec(), backend_upsert(), chat_turn(), ChatTurnRequest, credential_delete(), credential_get() (+64 more)
...
Cohesion: 0.06
Nodes (58): AskUserOption, AskUserPromptModel, buildChatExportPayload(), buildProjectInstructionsPromptContext(), buildProjectLinkPromptContext(), ChatExportFormat, clipVerboseText(), CoworkView() (+50 more)

### Community 7 - "AppHandle"
Cohesion: 0.06
Nodes (48): GuidedOnboarding(), GuidedOnboardingProps, persistState(), readStoredState(), baseProps, SecureCredentialInput(), SecureCredentialInputProps, TaskCreatePanel() (+40 more)
...
Cohesion: 0.06
Nodes (54): blockContentToText(), buildOllamaChatRequest(), buildStartTagRegex(), buildToolLookup(), canDelayVisibleStream(), canonicalizeArgumentKey(), canUseTauriInvoke(), clipOllamaDebugText() (+46 more)

### Community 10 - "Option"
Cohesion: 0.11
Nodes (17): streamOllamaMessagesMock, QueryEngine, chunk(), ToolOrchestrator, ContentBlock, ContentBlockToolResult, ContentBlockToolUse, ToolProgressData (+9 more)

### Community 11 - "tr"
Cohesion: 0.09
Nodes (28): buildDefaultCrewName(), CREW_STARTER_PRESETS, CrewPanel(), CrewProviderModelsResult, downloadCrewJson(), getCrewDiagnostics(), getProviderKey(), getProviderLabel() (+20 more)

### Community 12 - "index.ts"
Cohesion: 0.13
Nodes (15): formatDateTime(), getTabLabel(), MemoryPanel(), MemoryTab, randomId(), safeInvokeMock, truncateText(), FrozenSnapshot (+7 more)

### Community 13 - "Database"
Cohesion: 0.08
Nodes (33): backend_list(), claude_code_list_commands(), claude_code_list_tools(), CrewGovernanceAgentAccessPayload, CrewGovernancePayload, desktop_launch_app(), DesktopLaunchRequest, DesktopLaunchResponse (+25 more)

### Community 14 - "index.ts"
Cohesion: 0.07
Nodes (60): APIContentBlock, APIMessage, APIToolDef, calculateCost(), COST_PER_MILLION, sampleMessage(), SampleResult, StreamCallbacks (+52 more)
...
Cohesion: 0.07
Nodes (29): ModelSwitcher(), EMPTY_FORM, PersonalityEditor(), PersonalityForm, PersonalitySelector(), randomId(), ROLE_OPTIONS, toForm() (+21 more)
...
Cohesion: 0.05
Nodes (4): SessionRow, steps_with_task(), task_lifecycle(), SqlResult
...
Cohesion: 0.10
Nodes (45): agent_display_name(), build_agent(), build_governance_note(), build_llm(), build_memory_note(), build_task_description(), classify_runtime_error(), clean_log_text() (+37 more)
...
### Community 24 - "String"
Cohesion: 0.06
Nodes (15): CrewDefinitionVersionRow, EngineRunCheckpointRow, LearningOutcomeRow, ManagedProcessRow, MemoryProviderRow, PersonalityRow, ProjectRow, RpcPipelineRow (+7 more)

### Community 25 - "coworkStore.ts"
Cohesion: 0.05
Nodes (51): sanitizeConnectorsForPersistence(), sanitizeCrewsForPersistence(), sanitizeEngineConfigForPersistence(), sanitizeEnvironmentForPersistence(), sanitizeMcpServerForPersistence(), sanitizeProfilesForPersistence(), SecretConnector, SecretCrew (+43 more)

### Community 26 - "configStore.ts"
Cohesion: 0.12
Nodes (11): audit_event_insert(), diagnostic_database_sinks_redact_before_persistence(), engine_event_retention_keeps_the_latest_bounded_window(), engine_run_artifacts_round_trip_and_cascade(), engine_run_events_are_ordered_and_summarized(), engine_runs_capture_gateway_metadata(), insert_test_engine_run(), scheduled_run_claim_prevents_overlap_and_completion_updates_the_same_row() (+3 more)

### Community 27 - "context.rs"
Cohesion: 0.09
Nodes (22): Actor, ActorId, ActorKind, ActorRole, anonymous_fixture_has_no_actor_id(), ClientPlatform, context_serializes_with_camel_case_fields(), local_default_context_needs_no_network_config() (+14 more)
...
Cohesion: 0.11
Nodes (33): ANTHROPIC_MODELS, AnthropicConfig, listOllamaModels(), createEngineConfig(), DEFAULT_CONFIG, fromPersistedConfig(), FullEngineConfig, getAvailableModels() (+25 more)

### Community 31 - "mcp.rs"
Cohesion: 0.14
Nodes (46): local_docs_mcp_probe(), local_screenshot_mcp_probe(), mcp_probe(), call_tool(), format_call_result(), McpCallRequest, McpCallResponse, McpError (+38 more)

### Community 32 - "properties"
Cohesion: 0.05
Nodes (41): type, items, type, type, pattern, type, items, type (+33 more)
...
Cohesion: 0.06
Nodes (38): sessionRecord, sessionSummary, checkOllamaConnection(), getAllCommands(), EngineBackend, CrewTaskMessageParams, ContextSnapshot, autoSaveSession() (+30 more)
...
Cohesion: 0.10
Nodes (16): BashTool, CopyPathTool, EditFileTool, GlobTool, GrepTool, MovePathTool, OfficeWorkflowTool, Path (+8 more)

### Community 39 - "CrewLiveMonitor.tsx"
Cohesion: 0.10
Nodes (18): AskQuestionOption, ChatMessage, ChatState, CrewLiveEntryCategory, CrewLiveSeverity, CrewLiveStatus, DbMessage, getActiveThread() (+10 more)
...
Cohesion: 0.04
Nodes (88): authorize_worker_sandbox_source(), command_contains_path_traversal(), configure_pdfium_search_paths(), default_crew_execution_subject(), default_crew_governance_mode(), default_crew_output_mode(), desktop_capture_primary_annotated_screenshot(), desktop_capture_primary_display() (+80 more)

### Community 43 - "toolOrchestrator.ts"
Cohesion: 0.15
Nodes (7): autoSaveSessionMock, buildSystemPromptWithMemoryMock, FakeQueryEngine, invokeMock, loadSessionMock, queryBarriers, queryCalls

### Community 44 - "Vec"
Cohesion: 0.27
Nodes (14): clipText(), createFallbackUuid(), hydrateStoredMessage(), isChatRole(), parsePersistedSessionMessage(), parseStoredChatMessagePayload(), resolveDisplayRole(), resolveReadableContent() (+6 more)
...
Cohesion: 0.07
Nodes (31): pattern, type, type, items, type, items, type, properties (+23 more)
...
Cohesion: 0.14
Nodes (23): AuditService<S>, RecordingAuditSink, Into, Mutex, ServiceResult, audit_event_serializes_with_snake_case_contract_fields(), AuditEvent, AuditId (+15 more)
...
Cohesion: 0.07
Nodes (30): items, type, type, items, type, pattern, type, type (+22 more)

### Community 51 - "Message"
Cohesion: 0.13
Nodes (22): Any, _agent_access(), BashInput, build_runtime_tools(), _canonical_tool_id(), EditFileInput, _fetch_public_text(), GlobInput (+14 more)
...
Cohesion: 0.12
Nodes (24): formatDate(), getProjectTitleForThread(), ProjectView(), readDraggedThreadId(), DefaultLlmProfileIds, getResolvedProvider(), getProjectForThread(), extractFileAttachmentsFromFileList() (+16 more)
...
Cohesion: 0.18
Nodes (14): OllamaConfig, BackendPipelineExecutionResult, getLocalPipelines(), hasString(), isRecord(), normalizeRpcPipeline(), ParsedPipelineStep, parseJsonArray() (+6 more)

### Community 58 - "tauri.conf.json"
Cohesion: 0.07
Nodes (27): app, security, trayIcon, windows, build, beforeBuildCommand, beforeDevCommand, devUrl (+19 more)
...
Cohesion: 0.09
Nodes (29): AddProjectResourceInput, addUniqueResources(), DbProject, DbProjectResource, DeleteProjectOptions, generateId(), getEnabledProjectAttachments(), getEnabledProjectLinks() (+21 more)
...
Cohesion: 0.06
Nodes (10): CrewApprovalRow, CrewDefinitionRow, CrewRoleBindingRow, CrewRunEventRow, map_worker_sandbox_row(), memory_search_ranks_natural_language_terms_instead_of_requiring_exact_phrase(), MemoryEntryRow, Option (+2 more)
...
Cohesion: 0.08
Nodes (25): devDependencies, autoprefixer, @axe-core/playwright, eslint, @eslint/js, eslint-plugin-react-hooks, eslint-plugin-react-refresh, globals (+17 more)
...
Cohesion: 0.06
Nodes (100): append_audit_event(), integrity_report(), Option, Path, PathBuf, Result, String, Value (+92 more)

### Community 69 - "globalSearch.ts"
Cohesion: 0.12
Nodes (28): apply_provider_headers(), build_provider_chat_urls(), build_provider_model_urls(), connector_test_reachability(), ConnectorReachabilityRequest, ConnectorReachabilityResponse, crew_provider_health_check(), crew_provider_models_list() (+20 more)

### Community 70 - "RequestContext"
Cohesion: 0.12
Nodes (23): AuditSink, NoopAuditSink, Send, ServiceResult, Sync, EventSink, NoopEventSink, Send (+15 more)
...
Cohesion: 0.09
Nodes (21): 10. Abnahmekriterien fuer die UI, 11. Priorisierung fuer Open_Cowork, 12. Bezug zu bestehender Dokumentation, 1. Zweck und Scope, 2. UI-Ziele, 7. Desktop- und Fensterverhalten, 8. Accessibility, 9. Visuelle und textliche Anforderungen (+13 more)
...
Cohesion: 0.06
Nodes (84): CredentialLocator, attach_process_tree(), configure_process_tree(), ProcessTreeGuard, Child, Option, Result, Send (+76 more)
...
Cohesion: 0.10
Nodes (21): 5.1 Welcome Screen, 5.2 Cowork-Hauptansicht, 5.3 Plan-, Approval- und Task-UI, 5.4 Features-Ansicht, 5.5 Settings-Ansicht, 5. Anforderungen pro Ansicht, UI-020 Einstieg und Orientierung, UI-021 Guided Onboarding (+13 more)
...
### Community 82 - "logStore.ts"
Cohesion: 0.13
Nodes (24): active_toolset_inference_detects_custom_edits(), backend_file_mutations_respect_the_active_toolset_policy(), build_policy_tool_states(), build_toolset_policy(), crew_tool_allowed_by_flags(), default_policy_enabled_tool_ids_vec(), default_policy_flags(), deny_rule_errors_do_not_echo_sensitive_targets() (+16 more)
...
Cohesion: 0.11
Nodes (19): dependencies, class-variance-authority, clsx, i18next, lucide-react, react, react-dom, react-i18next (+11 more)
...
Cohesion: 0.06
Nodes (50): CrewRuntimePanel(), formatTimestamp(), hasTauriRuntimeMock, randomId(), RuntimeInstructionRow, RuntimeInstructionsPanel(), hydrateMcpServer(), initializeCredentialVault() (+42 more)
...
Cohesion: 0.10
Nodes (36): buildEngineUserInput(), allowFolderAttachments(), AttachmentPromptBuildResult, buildAttachmentPromptContext(), collectSnippets(), extractQueryTerms(), ExtractTextLimitedResponse, FsAttachmentMetadataEntry (+28 more)
...
Cohesion: 0.13
Nodes (27): add_column_if_missing(), configure_connection(), connection_pragmas_enforce_integrity_and_contention_policy(), corrupt_database_files_and_invalid_data_directories_are_rejected(), create_pre_migration_backup(), current_schema_version(), database_error(), database_test_dir() (+19 more)
...
Cohesion: 0.20
Nodes (10): Desktop Smoke Test, Desktop-Steuerung validieren, Durchklickrunde, Fehlerprotokoll, Minimalfreigabe, OpenAI Computer Use Debugging, Smoke-Start, Voraussetzungen (+2 more)
...
### Community 110 - "Development und Betrieb"
Cohesion: 0.17
Nodes (3): CrewRuntimeIntegrationTests, CrewRuntimeStatusTests, CrewRuntimeToolTests
...
Cohesion: 0.19
Nodes (8): Disclaimer, 1. Lokale Desktop-Tools fuer Gemma/Ollama, 2. Screenshot-MCP, 3. `ComputerUseAppTest`, Bekannte Namensfalle, Desktop-Steuerung und Computer Use, Uebersicht, Wann welchen Pfad nutzen?
...
### Community 130 - "5.2 Cowork-Hauptansicht"
Cohesion: 0.18
...
Cohesion: 0.17
Nodes (12): getSessionLabel(), getStatusLabel(), TerminalDock(), TerminalDockProps, xtermInstances, randomId(), TerminalPanel(), isRiskyTerminalCommand() (+4 more)
...
Cohesion: 0.04
Nodes (71): ExternalProviderHealthCheckResult, ExternalProviderModelsResult, LlmProfilesPanel(), modelSuffix(), parseNumericInput(), ProfileHealthState, ProfileModelsState, PROVIDER_LABELS (+63 more)
...
### Community 175 - ".list_artifact_exports"
Cohesion: 0.29
Nodes (7): CrewExecutionLogRow, CrewExecutionResponse, CrewHistoryPanel(), CrewRunEventRow, CrewRunHistoryRow, formatTimestamp(), Props

### Community 176 - "credentialPersistence.ts"
Cohesion: 0.11
Nodes (26): capture_screenshot_for_display_payload(), chat_turn_stream_cancel(), ChatStreamRegistry, fs_watch_list(), fs_watch_stop(), local_screenshot_mcp_call(), parse_bool_tool_arg(), parse_i64_tool_arg() (+18 more)
...
Cohesion: 0.17
Nodes (19): bounded_json_stays_valid_and_redacted(), bounds_utf8_text_without_splitting_characters(), is_sensitive_key(), normalized_key(), recursively_redacts_sensitive_keys_and_nested_environment_maps(), redact_and_bound_json_text(), redact_and_bound_text(), redact_delimited_value() (+11 more)

### Community 182 - "ChatTurnRequest"
Cohesion: 0.07
Nodes (50): ArtifactExportRow, build_exec_command_text(), crew_runs_list(), CrewRunHistoryRow, db_save_thread(), db_update_thread_permission_config(), db_update_thread_provider_settings(), decode_html_entities() (+42 more)
...
### Community 212 - "workTaskCrewRuntime.ts"
Cohesion: 0.05
Nodes (74): AgentStream, buildAgentStreams(), buildEntryMeta(), buildRollingWindowLines(), CATEGORY_LABELS, createEmptyCounts(), CrewLiveDisplayCategory, CrewLiveFilter (+66 more)

### Community 216 - "chatStore.ts"
Cohesion: 0.06
Nodes (53): App(), AppRoutes(), BackendPolicyState, confirmAppClose(), CoworkView, CrewView, FeaturesView, hasRunningWork() (+45 more)

### Community 227 - "processStore.ts"
Cohesion: 0.08
Nodes (32): CATEGORY_LABELS, CATEGORY_ORDER, CommandPalette(), FeaturesView(), isWorkbenchTab(), TABS, WorkbenchTab, Layout() (+24 more)

## Knowledge Gaps
- **1171 isolated node(s):** `hasTauriRuntimeMock`, `safeInvokeMock`, `baseAgent`, `CREW_STARTER_PRESETS`, `ProviderModelState` (+1166 more)
...
- **Why does `Database` connect `Result` to `String`, `Database`, `memoryStore.ts`, `useConfigStore`, `String`, `configStore.ts`, `webSearchSources.ts`, `LeftSidebar.tsx`, `.get_engine_run`, `sensitive_data.rs`, `db.rs`, `ChatTurnRequest`, `QueryEngine`, `.open_in_memory`, `RequestContext`, `terminal_backends.rs`, `logStore.ts`, `memory_engine.rs`, `skill_engine.rs`, `5.3 Plan-, Approval- und Task-UI`, `insights.rs`, `buildProductDoc`, `WorkTaskRow`?**
  _High betweenness centrality (0.130) - this node is a cross-community bridge._
- **Why does `CredentialLocator` connect `terminal_backends.rs` to `String`, `useTerminalStore`?**
  _High betweenness centrality (0.128) - this node is a cross-community bridge._
- **What connects `hasTauriRuntimeMock`, `safeInvokeMock`, `baseAgent` to the rest of the system?**
...
- **Should `Result` be split into smaller, more focused modules?**
  _Cohesion score 0.047494172494172496 - nodes in this community are weakly interconnected._
